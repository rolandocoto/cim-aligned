...
if __name__ == "__main__":
	...
	header = "phone,type,Filename,TextGridLabel,Word,PreviousLabel,FollowingLabel,start,end,duration,f0_0point,f0_10point,f0_20point,f0_25point,f0_30point,f0_33point,f0_40point,f0_50point,f0_60point,f0_67point,f0_70point,f0_75point,f0_80point,f0_90point,f0_100point,F1_midpoint,F2_midpoint,F3_midpoint,intensity_midpoint,next_Filename,next_TextGridLabel,next_Word,next_PreviousLabel,next_FollowingLabel,next_start,next_end,next_duration,next_f0_0point,next_f0_10point,next_f0_20point,next_f0_25point,next_f0_30point,next_f0_33point,next_f0_40point,next_f0_50point,next_f0_60point,next_f0_67point,next_f0_70point,next_f0_75point,next_f0_80point,next_f0_90point,next_f0_100point,next_F1_midpoint,next_F2_midpoint,next_F3_midpoint,next_intensity_midpoint"
	...
	for line in inputCSV:
		...
		if (letter in vowels):
			...
			word == nextWord):
				...
				res += letter + nextLetter + "," + "diphthong" + "," + line + inputCSV[lineNumber+1]
				
			# If it's a lone vowel (i.e. not followed by another vowel within the same word)
			else:
			
				res += letter + "," + "vowel" + "," + line
